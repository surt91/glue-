...
Cmd::Cmd(int argc, char** argv)
{
    ...
    try{
        ...
        TCLAP::ValueArg<int> thresholdArg("t", "threshold", "minimum number of entries in bin to use for glueing, or for WL how many bins at the edges to ignore", false, 10, "int", cmd);
